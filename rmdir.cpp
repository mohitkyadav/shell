...
DIR* c;
int dir_finder(char*);
int rmdir_find(char* dname) // Recursive function for finding file/directory and deleteing them
{
    ...
    {
        while ((dir = readdir(c)) != NULL)   // On successfull completion, returns pointer to the object "dir" of type "struct dirent"
        {
